...
public interface UserCustomService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserCustomServiceUtil} to access the user custom remote service. Add custom service methods to <code>com.liferay.amf.registration.service.impl.UserCustomServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
