...
public class UserCustomServiceHttp {
	...
	public static com.liferay.amf.registration.model.UserCustom addUserCustom(
			...
			boolean male, String homePhone, String mobilePhone,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, userId, male, homePhone, mobilePhone,
				serviceContext);
			...
			return (com.liferay.amf.registration.model.UserCustom)returnObj;
		}
