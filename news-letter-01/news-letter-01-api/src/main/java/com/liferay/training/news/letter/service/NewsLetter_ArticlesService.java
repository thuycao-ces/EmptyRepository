...
/**
 * Provides the remote service interface for NewsLetter_Articles. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see NewsLetter_ArticlesServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface NewsLetter_ArticlesService extends BaseService {
