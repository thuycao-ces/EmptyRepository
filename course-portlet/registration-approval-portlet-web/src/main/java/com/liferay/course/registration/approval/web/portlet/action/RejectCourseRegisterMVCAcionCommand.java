...
@Component(
	...
	property = {
		...
		"mvc.command.name=" + MVCCommandNames.REJECT_COURSE
	},
	service = MVCActionCommand.class
)
public class RejectCourseRegisterMVCAcionCommand extends BaseMVCActionCommand {
		...
		if (themeDisplay.isSignedIn()) {
			...
			try {
				_courseRegistrationService.updateCourseRegistration(
					courseRegistrationId, "Rejected");

				SessionMessages.add(actionRequest, "rejectCousreRegistrationSuccess");
