...
@Component(
	immediate = true,
	property = {
		"javax.portlet.name=" + CoursePortletKeys.COURSE, "mvc.command.name=/",
...
public class ViewCoursesMVCRenderCommand implements MVCRenderCommand {
	...
	private void addcourseListAttributes(RenderRequest renderRequest) {
		...
		String orderByCol = ParamUtil.getString(
			renderRequest, "orderByCol", "courseName");
		...
		OrderByComparator<Course> comparator =
			OrderByComparatorFactoryUtil.create(
				"course", orderByCol, !"asc".equals(orderByType));
		...
		renderRequest.setAttribute(
			"courseCount",
			_courseService.getCoursesCountByKeywords(
