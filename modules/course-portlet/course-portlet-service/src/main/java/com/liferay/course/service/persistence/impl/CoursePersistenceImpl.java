...
import com.liferay.course.service.persistence.impl.constants.COURSEPersistenceConstants;
...
public class CoursePersistenceImpl
	...
	public Course updateImpl(Course course) {
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {courseModelImpl.getGroupId()};
	...
	static {
		try {
			Class.forName(COURSEPersistenceConstants.class.getName());
		}
