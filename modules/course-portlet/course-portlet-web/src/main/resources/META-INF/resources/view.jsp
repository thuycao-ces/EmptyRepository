...
<div class="container-fluid-1280">
	<h1>
		<liferay-ui:message key="courses" />
	</h1>

	<%-- Clay management toolbar. --%>

	<clay:management-toolbar disabled="${courseCount eq 0}" displayContext="${coursesManagementToolbarDisplayContext}" itemsTotal="${courseCount}" searchContainerId="courseEntries" selectable="false" />
