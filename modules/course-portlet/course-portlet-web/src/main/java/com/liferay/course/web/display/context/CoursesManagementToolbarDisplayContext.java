...
public class CoursesManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

	public CoursesManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
		...
		return new CreationMenu() {
			{
				addDropdownItem(dropdownItem -> {
					dropdownItem.setHref(liferayPortletResponse.createRenderURL(), "mvcRenderCommandName",
							MVCCommandNames.EDIT_COURSE, "redirect", currentURLObj.toString());
					dropdownItem.setLabel(LanguageUtil.get(request, "add-course"));
				});
			}
		};
	}
	...
	public String getDisplayStyle() {
		...
		if (Validator.isNull(displayStyle)) {
			displayStyle = _portalPreferences.getValue(CoursePortletKeys.COURSE, "courses-display-style",
					"descriptive");
		} else {
			_portalPreferences.setValue(CoursePortletKeys.COURSE, "courses-display-style", displayStyle);
	...
	public String getSearchActionURL() {
		...
		searchURL.setProperty("mvcRenderCommandName", MVCCommandNames.VIEW_COURSES);
	...
	public List<ViewTypeItem> getViewTypeItems() {
		...
		String orderByCol = ParamUtil.getString(request, "orderByCol", "courseName");
	...
	protected List<DropdownItem> getOrderByDropdownItems() {
		return new DropdownItemList() {
			{
				add(dropdownItem -> {
					dropdownItem.setActive("courseName".equals(getOrderByCol()));
					dropdownItem.setHref(_getCurrentSortingURL(), "orderByCol", "courseName");
					dropdownItem.setLabel(LanguageUtil.get(request, "courseName"));
				});
	...
	private PortletURL _getCurrentSortingURL() throws PortletException {
		...
		sortingURL.setParameter("mvcRenderCommandName", MVCCommandNames.VIEW_COURSES);
